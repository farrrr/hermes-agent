...
# ---------------------------------------------------------------------------
# Attach tool methods to provider class so existing call sites work unchanged.
# provider._tool_search(args) dispatches to the free function in tools.py.
# ---------------------------------------------------------------------------

OpenVikingMemoryProvider._tool_search = lambda self, args: _tools._tool_search_impl(self, args)
OpenVikingMemoryProvider._tool_read = lambda self, args: _tools._tool_read_impl(self, args)
OpenVikingMemoryProvider._tool_browse = lambda self, args: _tools._tool_browse_impl(self, args)
OpenVikingMemoryProvider._tool_remember = lambda self, args: _tools._tool_remember_impl(self, args)
OpenVikingMemoryProvider._tool_add_resource = lambda self, args: _tools._tool_add_resource_impl(self, args)
